name: react+react-router 4.0+redux+antd  购物车实战项目
tag: react
description: 
...
github地址：https://duantengyuan.github.io/blog/react-shopping
## 脚手架
...
```
git clone https://duantengyuan.github.io/blog/react-shopping.git 
...
> 推荐一个vue2 的实战项目（仿网易云音乐） [https://i.csdn.net/#/uc/profiledetails/68156734](https://i.csdn.net/#/uc/profiledetails/68156734)

> 另外推荐一个 vue2 + vuex 的实战项目（实时聊天系统，有后台代码）。[https://i.csdn.net/#/uc/profiledetails/70807847](https://i.csdn.net/#/uc/profiledetails/70807847)
